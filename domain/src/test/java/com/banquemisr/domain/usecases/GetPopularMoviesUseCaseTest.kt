...
import com.banquemisr.domain.usecases.movielist_usecase.GetPopularMoviesUseCase
...
class GetPopularMoviesUseCaseTest{
    ...
    operator fun invoke() {
        runTest {
            ...
            coEvery { iMoviesRepository.getMovieListPopular(any()) } returns mockResult
            val result = GetPopularMoviesUseCase(iMoviesRepository).invoke(queryCharacters.page)
            coVerify { iMoviesRepository.getMovieListPopular(any()) }
